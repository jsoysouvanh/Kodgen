...
DefaultComplexPropertyRule::DefaultComplexPropertyRule(std::string mainPropName, std::unordered_set<EEntityType> validEntityTypes, std::string description) noexcept:
