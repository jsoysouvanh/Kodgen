...
"																																							\n"
"	class KGClass(GenTemplate[TestTemplate], ClassProp1, ClassProp2[ClassSubProp21, ClassSubProp22], ClassProp3) TestClass final : public Class1Typename, protected Class2, private Class3			\n"
"	{																																						\n"
"		private:																																			\n"
...
"	using Class1Typename = Class1*;																															\n"
"																																							\n"
"	class KGClass(GenTemplate[TestTemplate], ClassProp1, ClassProp2[ClassSubProp21, ClassSubProp22], ClassProp3) TestClassBis final : public Class1			\n"
"	{																																						\n"
"		private:																																			\n"
"		#pragma region Variables																															\n"
"																																							\n"
...
"	};																																						\n"
"																																							\n"
"	enum class KGEnum(GenTemplate[TestTemplate], EnumProp1, EnumProp2[EnumSubProp21, EnumSubProp22], EnumProp3) MyEnumBis : uint8_t							\n"
"	{																																						\n"
"		EVal1 KGEnumVal(EnumValueProp1, EnumValueProp2[EnumValueSubProp21, EnumValueSubProp22], EnumValueProp3) = 1 << 0,									\n"
"			EVal2 = 1 << 1,																																	\n"
"			a,																																				\n"
