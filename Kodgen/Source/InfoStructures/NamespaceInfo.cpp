...
NamespaceInfo::NamespaceInfo(CXCursor const& cursor, PropertyGroup2&& propertyGroup) noexcept:
	EntityInfo(cursor, std::forward<PropertyGroup2>(propertyGroup), EntityInfo::EType::Namespace)
{
}
