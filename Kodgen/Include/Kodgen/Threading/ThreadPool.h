...
namespace kodgen
{
	class ThreadPool
	{
		private:
			...
			*	
			*	@return An optional object filled with a ready-to-execute task if any, else an empty optional.
			*/
			opt::optional<Task>	getTask()		noexcept;

			/**
			*	@brief Instantly kill all workers by detaching threads.
			*/
			void				killWorkers()	noexcept;
