...
bool ComplexPropertyRule2::isUsedOnlyOnce(PropertyGroup2 const& propertyGroup, uint8 propertyIndex, std::string& out_errorDescription) const noexcept
{
...
bool ComplexPropertyRule2::hasValidSubpropCount(PropertyGroup2 const& propertyGroup, uint8 propertyIndex, uint8 validCount, std::string& out_errorDescription) const noexcept
{
